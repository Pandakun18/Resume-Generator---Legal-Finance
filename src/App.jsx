...
function LayoutChambers({ data, accent, accent2, nameFont, bodyFont }) {
  ...
  return (
    <div style={{ width:"8.5in", minHeight:"11in", background:"#FEFDFB", fontFamily:bodyFont, boxSizing:"border-box", boxShadow:"0 12px 40px -10px rgba(0,0,0,0.2)" }}>
...
function LayoutMeridian({ data, accent, accent2, nameFont, bodyFont }) {
  ...
  const ci = [data.contact?.email,data.contact?.phone,data.contact?.location,data.contact?.linkedin].filter(Boolean);
  return (
    <div style={{ width:"8.5in", minHeight:"11in", background:"#FAFAFA", fontFamily:bodyFont, boxSizing:"border-box", boxShadow:"0 12px 40px -10px rgba(0,0,0,0.22)" }}>
...
function LayoutCounsel({ data, accent, nameFont, bodyFont }) {
  const ci = [data.contact?.email,data.contact?.phone,data.contact?.location,data.contact?.linkedin].filter(Boolean);
  return (
    <div style={{ width:"8.5in", minHeight:"11in", background:"#F9F8F5", fontFamily:bodyFont, boxSizing:"border-box", display:"flex", boxShadow:"0 12px 40px -10px rgba(0,0,0,0.18)" }}>
...
function LayoutAnalyst({ data, accent, nameFont, bodyFont }) {
  const ci = [data.contact?.email,data.contact?.phone,data.contact?.location,data.contact?.linkedin].filter(Boolean);
  return (
    <div style={{ width:"8.5in", minHeight:"11in", background:"#FFFFFF", fontFamily:bodyFont, boxSizing:"border-box", boxShadow:"0 12px 40px -10px rgba(0,0,0,0.15)" }}>
...
function LayoutPartner({ data, accent, accent2, nameFont, bodyFont }) {
  ...
  const ci = [data.contact?.email,data.contact?.phone,data.contact?.location,data.contact?.linkedin].filter(Boolean);
  return (
    <div style={{ width:"8.5in", minHeight:"11in", background:"#F8F6F2", fontFamily:bodyFont, boxSizing:"border-box", boxShadow:"0 12px 40px -10px rgba(0,0,0,0.25)" }}>
...
function exportPDF(el, name) {
  ...
  const printCSS = `
    ...
    * { box-sizing: border-box; }
    ...
    div, span, p { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
  `;
